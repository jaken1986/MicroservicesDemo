...
namespace MicroservicesDemo.Web.Menus
{
    public class MicroservicesDemoMenuContributor : IMenuContributor
    {
        ...
        public MicroservicesDemoMenuContributor(IConfiguration configuration)
        {
        ...
        private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
        {
            ...
            context.Menu.Items.Insert(0, new ApplicationMenuItem(MicroservicesDemoMenus.Home, l["Menu:Home"], "~/"));
