...
namespace MicroservicesDemo.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update MicroservicesDemoDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update MicroservicesDemoEfCoreEntityExtensionMappings to extend the IdentityUser entity
